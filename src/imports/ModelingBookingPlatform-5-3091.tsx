import svgPaths from "./svg-ymbjerlvxa";
...
function ModelerManagement10({ children }: React.PropsWithChildren<{}>) {
  return (
    <div className="h-[52px] relative shrink-0 w-[926.222px]">
...
function Container82({ children }: React.PropsWithChildren<{}>) {
  return (
...
type Container81Props = {
  additionalClassNames?: string;
};

function Container81({ children, additionalClassNames = "" }: React.PropsWithChildren<Container81Props>) {
  return (
...
type Container80Props = {
  additionalClassNames?: string;
};

function Container80({ children, additionalClassNames = "" }: React.PropsWithChildren<Container80Props>) {
  return (
...
function Icon23({ children }: React.PropsWithChildren<{}>) {
  return (
...
function ContainerText6({ text }: ContainerText6Props) {
  return (
    <div className="h-[20px] relative shrink-0 w-full">
      <p className="absolute font-['Arimo:Regular','Noto_Sans:Regular',sans-serif] font-normal leading-[20px] left-0 text-[14px] text-neutral-950 top-[-2px] w-[34px]">{text}</p>
    </div>
  );
}
...
function TextText({ text }: TextTextProps) {
  return (
    <Wrapper3 additionalClassNames="h-[20px] w-[55.639px]">
...
function Container() {
  return (
    <Container80 additionalClassNames="bg-white rounded-[14px] size-[40px]">
      <Icon />
    </Container80>
  );
}
...
function Container7() {
  return (
    <Container80 additionalClassNames="bg-[rgba(255,255,255,0.05)] rounded-[10px] size-[36px]">
      <Icon2 />
    </Container80>
  );
}
...
function Container9() {
  return (
    <Container81 additionalClassNames="w-[139.556px]">
      <Container7 />
      <Container8 />
    </Container81>
  );
...
function Container14() {
  return (
    <Container81 additionalClassNames="w-[159.153px]">
      <Container12 />
      <Container13 />
    </Container81>
  );
...
function Container18() {
  return (
    <Container81 additionalClassNames="w-[164px]">
      <Container16 />
      <Container17 />
    </Container81>
  );
...
function Container22() {
  return (
    <Container81 additionalClassNames="w-[146.278px]">
      <Container20 />
      <Container21 />
    </Container81>
  );
...
function Container24() {
  return (
    <Container80 additionalClassNames="bg-black rounded-[10px] size-[36px]">
      <Icon6 />
    </Container80>
  );
}
...
function Container28() {
  return (
    <Container81 additionalClassNames="w-[105.861px]">
      <Container24 />
      <Container27 />
    </Container81>
  );
...
function Icon7() {
  return (
    <Wrapper6 additionalClassNames="h-[16px]">
...
function Container33() {
  return (
    <Container81 additionalClassNames="w-[128.625px]">
      <Container31 />
      <Container32 />
    </Container81>
  );
...
function Container38() {
  return (
    <Container81 additionalClassNames="w-[139.792px]">
      <Container36 />
      <Container37 />
    </Container81>
  );
...
function Container42() {
  return (
    <Container81 additionalClassNames="w-[155.194px]">
      <Container40 />
      <Container41 />
    </Container81>
  );
...
function Container45() {
  return <Wrapper4>{`Reports & insights`}</Wrapper4>;
}
...
function Container47() {
  return (
    <Container81 additionalClassNames="w-[145.417px]">
      <Container44 />
      <Container46 />
    </Container81>
  );
...
function Navigation() {
  return (
    <Wrapper6 additionalClassNames="w-[288px]">
      <Button />
      <Button1 />
      <Button2 />
      <Button3 />
...
function Dropdown() {
  return (
    <div className="absolute content-stretch flex flex-col h-[40px] items-start left-[268px] pb-[0.889px] pl-[-1176px] pr-[1288px] pt-[-108.875px] rounded-[8px] top-0 w-[112px]" data-name="Dropdown">
...
function Container52() {
  return (
    <Wrapper3 additionalClassNames="h-[40px] w-[380px]">
      <Dropdown />
      <Container51 />
    </Wrapper3>
  );
...
function Container56() {
  return (
    <div className="absolute content-stretch flex flex-col h-[60px] items-start left-0 top-0 w-[172.444px]" data-name="Container">
      <Text5 text="Contact" />
...
function Container57() {
  return (
    <div className="absolute content-stretch flex flex-col h-[60px] items-start left-[188.44px] top-0 w-[172.444px]" data-name="Container">
      <Text5 text="Base Price" />
...
function Container58() {
  return (
    <div className="absolute content-stretch flex flex-col h-[60px] items-start left-[376.89px] top-0 w-[172.444px]" data-name="Container">
      <Text5 text="Rating" />
...
function Container59() {
  return (
    <div className="absolute content-stretch flex flex-col h-[60px] items-start left-[565.33px] top-0 w-[172.444px]" data-name="Container">
      <Text5 text="Total Bookings" />
...
function Container60() {
  return (
    <div className="absolute content-stretch flex flex-col h-[60px] items-start left-[753.78px] top-0 w-[172.444px]" data-name="Container">
      <Text5 text="Joined" />
...
function App() {
  return (
    <div className="absolute bg-gray-50 content-stretch flex flex-col h-[1100.875px] items-start left-0 top-0 w-[1312px]" data-name="App">
      <AdminApp />
    </div>
  );
}
...
function Icon21() {
  return (
    <Icon22 additionalClassNames="absolute left-[16px] top-[16px]">
...
function App1() {
  return (
    <div className="absolute bg-black left-[1232px] opacity-[0.96] rounded-[2.98262e+07px] shadow-[0px_25px_50px_-12px_rgba(0,0,0,0.25)] size-[56px] top-[684.44px]" data-name="App">
      <Icon21 />
      <Text4 />
    </div>
  );
