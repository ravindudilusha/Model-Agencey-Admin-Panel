import svgPaths from "./svg-94xmuy53u3";
import clsx from "clsx";

function PaymentVerification9({ children }: React.PropsWithChildren<{}>) {
  return (
    <div className="bg-gray-50 h-[52px] relative rounded-[10px] shrink-0 w-[926.222px]">
...
function PaymentVerification8({ children }: React.PropsWithChildren<{}>) {
  return (
...
function Container69({ children }: React.PropsWithChildren<{}>) {
  return (
    <div className="h-[76px] relative shrink-0 w-[249.458px]">
...
type Container68Props = {
  additionalClassNames?: string;
};

function Container68({ children, additionalClassNames = "" }: React.PropsWithChildren<Container68Props>) {
  return (
...
function Card2({ children }: React.PropsWithChildren<{}>) {
  return (
    <div className="bg-white h-[406.667px] relative rounded-[14px] shrink-0 w-full">
  ...
  return (
    <div className="h-[48.889px] relative shrink-0 w-[926.222px]">
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[12px] items-start pb-0 pt-[16.889px] px-0 relative size-full">
        <ButtonText text="View Payment Slip" />
        <ButtonText1 text="Approve Payment" />
        <ButtonText2 text="Reject Payment" />
      </div>
    </div>
  );
}
...
function ButtonText2({ text }: ButtonText2Props) {
  return (
    <Wrapper5 additionalClassNames="bg-[#d4183d] w-[147.639px]">
      <Icon15 />
      <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[20px] left-[89.5px] text-[14px] text-center text-nowrap text-white top-[4px] translate-x-[-50%] whitespace-pre">{text}</p>
    </Wrapper5>
  );
}
...
function ButtonText1({ text }: ButtonText1Props) {
  return (
    <Wrapper5 additionalClassNames="bg-[#00a63e] w-[163.25px]">
      <Icon14 />
      <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[20px] left-[97px] text-[14px] text-center text-nowrap text-white top-[4px] translate-x-[-50%] whitespace-pre">{text}</p>
    </Wrapper5>
  );
}
...
function ButtonText({ text }: ButtonTextProps) {
  return (
    <div className="bg-white h-[32px] relative rounded-[8px] shrink-0 w-[168.792px]">
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Icon13 />
        <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[20px] left-[100.39px] text-[14px] text-center text-neutral-950 text-nowrap top-[4px] translate-x-[-50%] whitespace-pre">{text}</p>
      </div>
    </div>
  );
}
...
function TextText3({ text }: TextText3Props) {
  return (
    <Wrapper3 additionalClassNames="w-[275.736px]">
      <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[20px] left-0 text-[14px] text-neutral-950 top-[-2px] w-[276px]">{text}</p>
    </Wrapper3>
  );
}
...
function Icon12() {
  return (
    <Wrapper1>
      <path d={svgPaths.p31172880} id="Vector" stroke="var(--stroke-0, #4A5565)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
      <path d={svgPaths.p3abdf300} id="Vector_2" stroke="var(--stroke-0, #4A5565)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
...
function ContainerText6({ text }: ContainerText6Props) {
  return (
    <div className="h-[28px] relative shrink-0 w-full">
      <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[28px] left-0 text-[18px] text-neutral-950 top-[-1.22px] w-[78px]">{text}</p>
    </div>
  );
}
...
function BadgeText1({ text }: BadgeText1Props) {
  return (
    <div className="h-[21.764px] relative rounded-[8px] shrink-0 w-[62.986px]">
...
function ParagraphText({ text }: ParagraphTextProps) {
  return (
    <div className="h-[20px] relative shrink-0 w-full">
      <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[20px] left-0 text-[#6a7282] text-[14px] top-[-2px] w-[139px]">{text}</p>
    </div>
  );
}
type TextText2Props = {
...
function TextText2({ text }: TextText2Props) {
  return (
    <Wrapper3 additionalClassNames="w-[96.861px]">
      <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[20px] left-0 text-[#4a5565] text-[14px] top-[-2px] w-[97px]">{text}</p>
    </Wrapper3>
  );
}
type Text5Props = {
...
function TextText({ text }: TextTextProps) {
  return (
    <Wrapper3 additionalClassNames="w-[122.903px]">
      <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[20px] left-0 text-[#4a5565] text-[14px] top-[-2px] w-[123px]">{text}</p>
    </Wrapper3>
  );
}
...
function HeadingText({ text }: HeadingTextProps) {
  return (
    <div className="content-stretch flex h-[31.986px] items-start relative shrink-0 w-full">
      <p className="basis-0 font-['Arimo:Regular',sans-serif] font-normal grow leading-[32px] min-h-px min-w-px relative shrink-0 text-[24px] text-neutral-950">{text}</p>
    </div>
  );
}
...
function Container9() {
  return (
    <Container68 additionalClassNames="w-[139.556px]">
      <Container7 />
      <Container8 />
    </Container68>
  );
...
function Container14() {
  return (
    <Container68 additionalClassNames="w-[159.153px]">
      <Container12 />
      <Container13 />
    </Container68>
  );
...
function Container18() {
  return (
    <Container68 additionalClassNames="w-[164px]">
      <Container16 />
      <Container17 />
    </Container68>
  );
...
function Container22() {
  return (
    <Container68 additionalClassNames="w-[146.278px]">
      <Container20 />
      <Container21 />
    </Container68>
  );
...
function Container26() {
  return (
    <Container68 additionalClassNames="w-[105.861px]">
      <Container24 />
      <Container25 />
    </Container68>
  );
...
function Container30() {
  return (
    <Container68 additionalClassNames="w-[128.625px]">
      <Container24 />
      <Container29 />
    </Container68>
  );
...
function Container35() {
  return (
    <Container68 additionalClassNames="w-[139.792px]">
      <Container33 />
      <Container34 />
    </Container68>
  );
...
function Container38() {
  return (
    <div className="content-stretch flex h-[20px] items-start relative shrink-0 w-full" data-name="Container">
      <p className="basis-0 font-['Arimo:Regular',sans-serif] font-normal grow leading-[20px] min-h-px min-w-px relative shrink-0 text-[14px] text-black">Payments</p>
    </div>
  );
}
...
function Container39() {
  return (
    <div className="content-stretch flex h-[15.986px] items-start relative shrink-0 w-full" data-name="Container">
      <p className="font-['Arimo:Regular',sans-serif] font-normal leading-[16px] relative shrink-0 text-[#4a5565] text-[12px] text-nowrap whitespace-pre">Payment verification</p>
    </div>
  );
}
...
function Container41() {
  return (
    <Container68 additionalClassNames="w-[155.194px]">
      <Container37 />
      <Container40 />
    </Container68>
  );
...
function Container42() {
  return (
    <div className="h-[21.764px] relative shrink-0 w-[48.694px]" data-name="Container">
...
function Button7() {
  return (
    <div className="absolute bg-white h-[64px] left-[16px] overflow-clip rounded-[14px] shadow-[0px_10px_15px_-3px_rgba(0,0,0,0.1),0px_4px_6px_-4px_rgba(0,0,0,0.1)] top-[520px] w-[256px]" data-name="Button">
      <Container43 />
    </div>
  );
}
...
function Container47() {
  return (
    <Container68 additionalClassNames="w-[145.417px]">
      <Container44 />
      <Container46 />
    </Container68>
  );
...
function Sidebar() {
  return (
    <div className="bg-gradient-to-b from-[#000000] h-[1018.194px] relative shrink-0 to-[#000000] via-50% via-[#101828] w-[288px]" data-name="Sidebar">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <Container6 />
        <Navigation />
        <Container50 />
...
function Container51() {
  return (
    <div className="content-stretch flex gap-[12px] h-[20px] items-center relative shrink-0 w-full" data-name="Container">
      <TextText text="Payment ID: PAY001" />
      <TextText1 text="•" />
      <TextText2 text="Booking: BR002" />
    </div>
  );
}
...
function Container52() {
  return (
    <Container69>
      <HeadingText1 text="Fashion Show" />
      <Container51 />
      <ParagraphText text="Uploaded: 11/23/2025" />
    </Container69>
  );
}
...
function Container53() {
  return (
    <div className="absolute content-stretch flex flex-col h-[60px] items-start left-0 top-0 w-[298.069px]" data-name="Container">
      <Text5 text="Customer" />
      <ContainerText4 text="John Smith" />
      <ContainerText4 text="ABC Corporation" />
    </div>
  );
}
...
function Container54() {
  return (
    <div className="absolute content-stretch flex flex-col h-[60px] items-start left-[314.07px] top-0 w-[298.069px]" data-name="Container">
      <Text5 text="Model" />
      <ContainerText5 text="ID: M001" />
    </div>
  );
}
...
function Container55() {
  return (
    <div className="absolute content-stretch flex flex-col h-[60px] items-start left-[628.14px] top-0 w-[298.083px]" data-name="Container">
      <Text5 text="Amount" />
      <ContainerText6 text="LKR 5,000" />
    </div>
  );
}
...
function Container56() {
  return (
    <div className="content-stretch flex gap-[8px] h-[20px] items-center relative shrink-0 w-full" data-name="Container">
      <Icon12 />
      <TextText3 text="Payment Slip: payment_slip_booking_001.jpg" />
    </div>
  );
}
...
function Container57() {
  return (
    <div className="content-stretch flex gap-[12px] h-[20px] items-center relative shrink-0 w-full" data-name="Container">
      <TextText text="Payment ID: PAY002" />
      <TextText1 text="•" />
      <TextText2 text="Booking: BR003" />
    </div>
  );
}
...
function Container58() {
  return (
    <Container69>
      <HeadingText1 text="Product Launch" />
      <Container57 />
      <ParagraphText text="Uploaded: 11/22/2025" />
    </Container69>
  );
}

function PaymentVerification4() {
  return (
    <PaymentVerification8>
      <Container58 />
      <BadgeText1 text="pending" />
...
function Container59() {
  return (
    <div className="absolute content-stretch flex flex-col h-[60px] items-start left-0 top-0 w-[298.069px]" data-name="Container">
      <Text5 text="Customer" />
      <ContainerText4 text="Jane Doe" />
      <ContainerText4 text="XYZ Events" />
    </div>
  );
}
...
function Container61() {
  return (
    <div className="absolute content-stretch flex flex-col h-[60px] items-start left-[628.14px] top-0 w-[298.083px]" data-name="Container">
      <Text5 text="Amount" />
      <ContainerText6 text="LKR 6,000" />
    </div>
  );
}

function PaymentVerification5() {
  return (
    <Wrapper4>
      <Container59 />
      <Container60 />
...
function Container62() {
  return (
    <div className="content-stretch flex gap-[8px] h-[20px] items-center relative shrink-0 w-full" data-name="Container">
      <Icon12 />
      <TextText3 text="Payment Slip: payment_slip_booking_002.jpg" />
    </div>
  );
}

function PaymentVerification6() {
  return (
    <PaymentVerification9>
      <Container62 />
    </PaymentVerification9>
...
function Card1() {
  return (
    <Card2>
      <PaymentVerification4 />
      <PaymentVerification5 />
      <PaymentVerification6 />
      <PaymentVerification3 />
    </Card2>
  );
}
...
function Container63() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] h-[829.333px] items-start relative shrink-0 w-full" data-name="Container">
      <Card />
      <Card1 />
    </div>
  );
...
function PaymentVerification7() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] h-[885.319px] items-start relative shrink-0 w-full" data-name="PaymentVerification">
      <HeadingText text="Payment Verification" />
      <Container63 />
    </div>
  );
}
...
function Container64() {
  return (
    <div className="basis-0 bg-gray-50 grow h-[1018.194px] min-h-px min-w-px relative shrink-0" data-name="Container">
...
function AdminDashboard() {
  return (
    <div className="bg-gray-50 content-stretch flex h-[1018.194px] items-start relative shrink-0 w-full" data-name="AdminDashboard">
      <Sidebar />
      <Container64 />
    </div>
  );
...
function AdminApp() {
  return (
    <div className="bg-gray-50 content-stretch flex flex-col h-[1018.194px] items-start relative shrink-0 w-full" data-name="AdminApp">
      <AdminDashboard />
    </div>
  );
}
...
function App() {
  return (
    <div className="absolute bg-gray-50 content-stretch flex flex-col h-[1018.194px] items-start left-0 top-0 w-[1312px]" data-name="App">
      <AdminApp />
    </div>
  );
}
...
function App1() {
  return (
    <div className="absolute bg-black left-[1232px] opacity-[0.896] rounded-[2.98262e+07px] shadow-[0px_25px_50px_-12px_rgba(0,0,0,0.25)] size-[56px] top-[684.44px]" data-name="App">
      <Icon17 />
      <Text4 />
    </div>
  );
