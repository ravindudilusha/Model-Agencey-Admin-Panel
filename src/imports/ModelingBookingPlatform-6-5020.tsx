import svgPaths from "./svg-gz0260pbl2";
import clsx from "clsx";

function CustomerManagement12({ children }: React.PropsWithChildren<{}>) {
  return (
    <div className="h-[48.889px] relative shrink-0 w-[926.111px]">
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[12px] items-start pb-0 pt-[16.889px] px-0 relative size-full">{children}</div>
    </div>
  );
}

function CustomerManagement11({ children }: React.PropsWithChildren<{}>) {
  return (
    <div className="h-[80px] relative shrink-0 w-[926.111px]">
...
function Container111({ children }: React.PropsWithChildren<{}>) {
  return (
    <div className="h-[80px] relative shrink-0 w-[187.806px]">
...
type Container110Props = {
  additionalClassNames?: string;
};

function Container110({ children, additionalClassNames = "" }: React.PropsWithChildren<Container110Props>) {
  return (
...
type Container109Props = {
  additionalClassNames?: string;
};

function Container109({ children, additionalClassNames = "" }: React.PropsWithChildren<Container109Props>) {
  return (
...
function Container108({ children }: React.PropsWithChildren<{}>) {
  return (
    <div className="bg-gray-50 h-[59.986px] relative rounded-[4px] shrink-0 w-full">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center justify-between px-[12px] py-0 relative size-full">{children}</div>
      </div>
    </div>
  );
}
...
function Card3({ children }: React.PropsWithChildren<{}>) {
  return (
    <div className="bg-white h-[318.667px] relative rounded-[14px] shrink-0 w-full">
...
function Icon22({ children, additionalClassNames = "" }: React.PropsWithChildren<Icon22Props>) {
  return (
...
function PrimitiveLabelText({ text }: PrimitiveLabelTextProps) {
  return (
    <div className="h-[14px] relative shrink-0 w-full">
      <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[14px] left-0 text-[14px] text-neutral-950 text-nowrap top-[-1.67px] whitespace-pre">{text}</p>
    </div>
  );
}
type Text8Props = {
...
function ButtonText1({ text }: ButtonText1Props) {
  return (
    <div className="bg-white h-[32px] relative rounded-[8px] shrink-0 w-[123.5px]">
      ...
      <Text8 text={text} additionalClassNames="px-[12.889px] py-[0.889px]" />
    </div>
  );
}
...
function ButtonText({ text }: ButtonTextProps) {
  return (
    <div className="bg-white h-[32px] relative rounded-[8px] shrink-0 w-[129.5px]">
      <div aria-hidden="true" className="absolute border-[0.889px] border-[rgba(0,0,0,0.1)] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Icon14 />
        <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[20px] left-[80.39px] text-[14px] text-center text-neutral-950 text-nowrap top-[4px] translate-x-[-50%] whitespace-pre">{text}</p>
      </div>
    </div>
  );
}
...
function BadgeText1({ text, additionalClassNames = "" }: BadgeText1Props) {
  return (
    <Wrapper2 additionalClassNames={clsx("h-[21.764px] relative rounded-[8px] shrink-0", additionalClassNames)}>
...
function TextText2({ text }: TextText2Props) {
  return (
    <Wrapper3 additionalClassNames="h-[20px] w-[106.375px]">
...
function TextText({ text }: TextTextProps) {
  return (
    <Wrapper3 additionalClassNames="h-[20px] w-[51.736px]">
      <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[20px] left-0 text-[#4a5565] text-[14px] top-[-2px] w-[52px]">{text}</p>
    </Wrapper3>
  );
}
...
function ParagraphText({ text }: ParagraphTextProps) {
  return (
    <div className="h-[24px] relative shrink-0 w-full">
      <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[24px] left-0 text-[#4a5565] text-[16px] text-nowrap top-[-2.11px] whitespace-pre">{text}</p>
    </div>
  );
}
...
function BadgeText({ text, additionalClassNames = "" }: BadgeTextProps) {
  return (
    <Wrapper2 additionalClassNames={clsx("bg-[#d4183d] h-[21.764px] relative rounded-[8px] shrink-0", additionalClassNames)}>
...
function Icon() {
  return (
    <Icon21 additionalClassNames="relative shrink-0">
...
function Container() {
  return (
    <Container109 additionalClassNames="bg-white rounded-[14px] size-[40px]">
      <Icon />
    </Container109>
  );
}
...
function Icon2() {
  return (
    <Icon22 additionalClassNames="relative shrink-0">
...
function Container7() {
  return (
    <Container109 additionalClassNames="bg-[rgba(255,255,255,0.05)] rounded-[10px] size-[36px]">
      <Icon2 />
    </Container109>
  );
}
...
function Container9() {
  return (
    <Container110 additionalClassNames="w-[139.556px]">
      <Container7 />
      <Container8 />
    </Container110>
  );
...
function Container14() {
  return (
    <Container110 additionalClassNames="w-[159.153px]">
      <Container12 />
      <Container13 />
    </Container110>
  );
...
function Container18() {
  return (
    <Container110 additionalClassNames="w-[164px]">
      <Container16 />
      <Container17 />
    </Container110>
  );
...
function Container22() {
  return (
    <Container110 additionalClassNames="w-[146.278px]">
      <Container20 />
      <Container21 />
    </Container110>
  );
...
function Container26() {
  return (
    <Container110 additionalClassNames="w-[105.861px]">
      <Container24 />
      <Container25 />
    </Container110>
  );
...
function Container29() {
  return (
    <Container109 additionalClassNames="bg-black rounded-[10px] size-[36px]">
      <Icon7 />
    </Container109>
  );
}
...
function Container30() {
  return (
    <div className="content-stretch flex h-[20px] items-start relative shrink-0 w-full" data-name="Container">
      <p className="basis-0 font-['Arimo:Regular',sans-serif] font-normal grow leading-[20px] min-h-px min-w-px relative shrink-0 text-[14px] text-black">Customers</p>
    </div>
  );
}
...
function Container31() {
  return (
    <div className="content-stretch flex h-[15.986px] items-start relative shrink-0 w-full" data-name="Container">
      <p className="font-['Arimo:Regular',sans-serif] font-normal leading-[16px] relative shrink-0 text-[#4a5565] text-[12px] text-nowrap whitespace-pre">Client accounts</p>
    </div>
  );
}
...
function Container33() {
  return (
    <Container110 additionalClassNames="w-[128.625px]">
      <Container29 />
      <Container32 />
    </Container110>
  );
...
function Icon8() {
  return (
    <Wrapper8 additionalClassNames="h-[16px]">
...
function Button5() {
  return (
    <div className="absolute bg-white h-[64px] left-[16px] overflow-clip rounded-[14px] shadow-[0px_10px_15px_-3px_rgba(0,0,0,0.1),0px_4px_6px_-4px_rgba(0,0,0,0.1)] top-[376px] w-[256px]" data-name="Button">
      <Container35 />
    </div>
  );
}
...
function Container38() {
  return (
    <Container110 additionalClassNames="w-[139.792px]">
      <Container36 />
      <Container37 />
    </Container110>
  );
...
function Container42() {
  return (
    <Container110 additionalClassNames="w-[155.194px]">
      <Container40 />
      <Container41 />
    </Container110>
  );
...
function Container47() {
  return (
    <Container110 additionalClassNames="w-[145.417px]">
      <Container44 />
      <Container46 />
    </Container110>
  );
...
function Navigation() {
  return (
    <Wrapper8 additionalClassNames="w-[288px]">
      <Button />
      <Button1 />
      <Button2 />
      <Button3 />
...
function Sidebar() {
  return (
    <div className="bg-gradient-to-b from-[#000000] h-[1184.875px] relative shrink-0 to-[#000000] via-50% via-[#101828] w-[288px]" data-name="Sidebar">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <Container6 />
        <Navigation />
        <Container50 />
...
function Heading2() {
  return (
    <div className="h-[31.986px] relative shrink-0 w-[250.139px]" data-name="Heading 2">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Arimo:Regular',sans-serif] font-normal leading-[32px] relative shrink-0 text-[24px] text-neutral-950 text-nowrap whitespace-pre">Customer Management</p>
      </div>
    </div>
  );
}
...
function Dropdown() {
  return (
    <div className="absolute h-[40px] left-[268px] rounded-[8px] top-0 w-[125.333px]" data-name="Dropdown">
      ...
      <div className="size-full">
        <div className="content-stretch flex flex-col items-start pb-[0.889px] pl-[-1162.556px] pr-[1287.889px] pt-[-108.875px] relative size-full">
          <OptionText text="All Status" />
          <OptionText text="Active" />
          <OptionText text="Suspended" />
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="absolute bg-[#f3f3f5] h-[36px] left-0 rounded-[8px] top-0 w-[256px]" data-name="Input">
      <div className="content-stretch flex items-center overflow-clip pl-[40px] pr-[12px] py-[4px] relative rounded-[inherit] size-full">
        <p className="font-['Arimo:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#717182] text-[14px] text-nowrap whitespace-pre">Search customers...</p>
      </div>
      <div aria-hidden="true" className="absolute border-[0.889px] border-[rgba(0,0,0,0)] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
  );
...
function Container52() {
  return (
    <Wrapper3 additionalClassNames="h-[40px] w-[393.333px]">
      <Dropdown />
      <Container51 />
    </Wrapper3>
  );
...
function Container54() {
  return (
    <div className="content-stretch flex gap-[12px] h-[20px] items-center relative shrink-0 w-full" data-name="Container">
      <TextText text="ID: C001" />
      <TextText1 text="•" />
      <TextText2 text="NIC: 900123456V" />
    </div>
  );
}
...
function Container55() {
  return (
    <Container111>
      ...
      <ParagraphText text="ABC Corporation" />
      <Container54 />
    </Container111>
  );
}
...
function Container56() {
  return (
    <div className="absolute content-stretch flex flex-col h-[60px] items-start left-0 top-0 w-[219.528px]" data-name="Container">
      <Text7 text="Contact" />
      <ContainerText4 text="+94 77 123 4567" />
      <ContainerText4 text="john@abc.com" />
    </div>
  );
}
...
function Container57() {
  return (
    <div className="absolute content-stretch flex flex-col h-[60px] items-start left-[235.53px] top-0 w-[219.528px]" data-name="Container">
      <Text7 text="Total Bookings" />
      <ContainerText4 text="5" />
    </div>
  );
}
...
function Container58() {
  return (
    <div className="absolute content-stretch flex flex-col h-[60px] items-start left-[471.06px] top-0 w-[219.528px]" data-name="Container">
      <Text7 text="Joined Date" />
      <ContainerText4 text="3/15/2025" />
    </div>
  );
}

function CustomerManagement1() {
  return (
    <Wrapper3 additionalClassNames="h-[60px] w-[926.111px]">
      <Container56 />
      <Container57 />
      <Container58 />
    </Wrapper3>
...
function Icon15() {
  return (
    <Wrapper1 additionalClassNames="absolute left-[10px] top-[8px]">
      <g clipPath="url(#clip0_6_4562)" id="Icon">
        <path d={svgPaths.p300518c0} id="Vector" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
...
function Button10() {
  return (
    <Wrapper4 additionalClassNames="bg-[#d4183d] w-[104.306px]">
      <Icon15 />
      <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[20px] left-[67px] text-[14px] text-center text-nowrap text-white top-[4px] translate-x-[-50%] whitespace-pre">Suspend</p>
    </Wrapper4>
  );
}

function CustomerManagement2() {
  return (
    <CustomerManagement12>
      <ButtonText text="View Details" />
      <Button10 />
      <ButtonText1 text="Reset Password" />
    </CustomerManagement12>
  );
}
...
function Container59() {
  return (
    <div className="content-stretch flex gap-[12px] h-[20px] items-center relative shrink-0 w-full" data-name="Container">
      <TextText text="ID: C002" />
      <TextText1 text="•" />
      <TextText2 text="NIC: 910234567V" />
    </div>
  );
}
...
function Container60() {
  return (
    <Container111>
      <HeadingText text="Jane Doe" />
      <ParagraphText text="XYZ Events" />
      <Container59 />
    </Container111>
  );
}

function CustomerManagement3() {
  return (
    <CustomerManagement11>
      <Container60 />
      <BadgeText1 text="active" additionalClassNames="bg-[#00a63e] w-[49.528px]" />
...
function Container61() {
  return (
    <div className="absolute content-stretch flex flex-col h-[60px] items-start left-0 top-0 w-[219.528px]" data-name="Container">
      ...
      <ContainerText4 text="jane@xyz.com" />
    </div>
  );
}
...
function Container63() {
  return (
    <div className="absolute content-stretch flex flex-col h-[60px] items-start left-[471.06px] top-0 w-[219.528px]" data-name="Container">
      <Text7 text="Joined Date" />
      <ContainerText4 text="2/10/2025" />
    </div>
  );
}

function CustomerManagement4() {
  return (
    <Wrapper3 additionalClassNames="h-[60px] w-[926.111px]">
      <Container61 />
      <Container62 />
...
function Icon16() {
  return (
    <Wrapper1 additionalClassNames="absolute left-[10px] top-[8px]">
      <g clipPath="url(#clip0_6_4558)" id="Icon">
        <path d={svgPaths.p1df0e700} id="Vector" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
        <path d={svgPaths.p39ee6532} id="Vector_2" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
      </g>
      <defs>
...
function Container64() {
  return (
    <div className="content-stretch flex gap-[12px] h-[20px] items-center relative shrink-0 w-full" data-name="Container">
      <TextText text="ID: C003" />
      <TextText1 text="•" />
      <TextText2 text="NIC: 920345678V" />
    </div>
  );
}
...
function Container65() {
  return (
    <Container111>
      <HeadingText text="Bob Wilson" />
      <ParagraphText text="Elite Productions" />
      <Container64 />
    </Container111>
  );
}

function CustomerManagement6() {
  return (
    <CustomerManagement11>
      <Container65 />
      <BadgeText1 text="suspended" additionalClassNames="bg-[#e7000b] w-[76.583px]" />
    </CustomerManagement11>
  );
}
...
function Container66() {
  return (
    <div className="absolute content-stretch flex flex-col h-[60px] items-start left-0 top-0 w-[219.528px]" data-name="Container">
      ...
      <ContainerText4 text="bob@elite.com" />
    </div>
  );
}
...
function Container68() {
  return (
    <div className="absolute content-stretch flex flex-col h-[60px] items-start left-[471.06px] top-0 w-[219.528px]" data-name="Container">
      <Text7 text="Joined Date" />
      <ContainerText4 text="4/20/2025" />
    </div>
  );
}

function CustomerManagement7() {
  return (
    <Wrapper3 additionalClassNames="h-[60px] w-[926.111px]">
      <Container66 />
      <Container67 />
...
function Icon17() {
  return (
    <Wrapper1 additionalClassNames="absolute left-[10px] top-[8px]">
      <g clipPath="url(#clip0_6_4554)" id="Icon">
        <path d={svgPaths.p3bd56180} id="Vector" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
...
function Button12() {
  return (
    <Wrapper4 additionalClassNames="bg-[#030213] w-[101.292px]">
      <Icon17 />
...
function Container69() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] h-[988px] items-start relative shrink-0 w-full" data-name="Container">
      <Card />
      <Card1 />
      <Card2 />
    </div>
...
function CustomerManagement9() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] h-[1052px] items-start relative shrink-0 w-full" data-name="CustomerManagement">
      <Container53 />
      <Container69 />
    </div>
  );
...
function Container70() {
  return (
    <div className="basis-0 bg-gray-50 grow h-[1184.875px] min-h-px min-w-px relative shrink-0" data-name="Container">
...
function AdminDashboard() {
  return (
    <div className="bg-gray-50 content-stretch flex h-[1184.875px] items-start relative shrink-0 w-full" data-name="AdminDashboard">
      <Sidebar />
      <Container70 />
    </div>
  );
...
function AdminApp() {
  return (
    <div className="bg-gray-50 content-stretch flex flex-col h-[1184.875px] items-start relative shrink-0 w-full" data-name="AdminApp">
      <AdminDashboard />
    </div>
  );
}
...
function App() {
  return (
    <div className="absolute bg-gray-50 content-stretch flex flex-col h-[1184.875px] items-start left-0 top-0 w-[1311.889px]" data-name="App">
      <AdminApp />
    </div>
  );
}
...
function Heading() {
  return (
    <div className="content-stretch flex h-[31.986px] items-start relative shrink-0 w-full" data-name="Heading 1">
      <p className="basis-0 font-['Arimo:Regular',sans-serif] font-normal grow leading-[32px] min-h-px min-w-px relative shrink-0 text-[24px] text-neutral-950">Customers</p>
    </div>
  );
}
...
function PrimitiveH() {
  return (
    <div className="absolute h-[18px] left-[24px] top-[-175.11px] w-[445.333px]" data-name="Primitive.h2">
      <p className="absolute font-['Arimo:Bold',sans-serif] font-bold leading-[18px] left-0 text-[18px] text-neutral-950 text-nowrap top-[-1.56px] whitespace-pre">Customer Details</p>
    </div>
  );
}
...
function Heading3() {
  return (
    <div className="h-[24px] relative shrink-0 w-full" data-name="Heading 3">
      <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[24px] left-0 text-[16px] text-neutral-950 text-nowrap top-[-2.11px] whitespace-pre">John Smith</p>
    </div>
  );
}
...
function Container74() {
  return (
    <div className="h-[20px] relative shrink-0 w-full" data-name="Container">
      <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[20px] left-0 text-[#4a5565] text-[14px] top-[-2px] w-[116px]">Customer ID: C001</p>
    </div>
  );
}
...
function Container75() {
  return (
    <div className="h-[20px] relative shrink-0 w-full" data-name="Container">
      <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[20px] left-0 text-[#4a5565] text-[14px] top-[-2px] w-[107px]">NIC: 900123456V</p>
    </div>
  );
}
...
function Container76() {
  return (
    <div className="h-[20px] relative shrink-0 w-full" data-name="Container">
      <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[20px] left-0 text-[#4a5565] text-[14px] top-[-2px] w-[170px]">Company: ABC Corporation</p>
    </div>
  );
}
...
function Badge() {
  return (
    <div className="absolute bg-[#00a63e] h-[21.764px] left-[48.5px] rounded-[8px] top-0 w-[49.528px]" data-name="Badge">
...
function Container77() {
  return (
    <div className="h-[21.764px] relative shrink-0 w-full" data-name="Container">
      <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[20px] left-0 text-[#4a5565] text-[14px] text-nowrap top-[-1.13px] whitespace-pre">Status:</p>
      <Badge />
    </div>
  );
}
...
function Container78() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] h-[93.764px] items-start relative shrink-0 w-full" data-name="Container">
      <Container74 />
      <Container75 />
      <Container76 />
      <Container77 />
...
function Container79() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[8px] h-[146.653px] items-start left-0 pb-[0.889px] pt-0 px-0 top-0 w-[445.333px]" data-name="Container">
...
function Container80() {
  return (
    <div className="absolute bg-gray-50 content-stretch flex flex-col gap-[4px] h-[63.986px] items-start left-0 pb-0 pt-[12px] px-[12px] rounded-[4px] top-0 w-[214.667px]" data-name="Container">
      <ContainerText5 text="Email" />
      <ContainerText4 text="john@abc.com" />
    </div>
  );
}
...
function Container81() {
  return (
    <div className="absolute bg-gray-50 content-stretch flex flex-col gap-[4px] h-[63.986px] items-start left-[230.67px] pb-0 pt-[12px] px-[12px] rounded-[4px] top-0 w-[214.667px]" data-name="Container">
      <ContainerText5 text="Phone" />
      <ContainerText4 text="+94 77 123 4567" />
    </div>
  );
}
...
function Container82() {
  return (
    <div className="h-[63.986px] relative shrink-0 w-full" data-name="Container">
      <Container80 />
      <Container81 />
    </div>
  );
...
function Container83() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[8px] h-[85.986px] items-start left-0 top-[166.65px] w-[445.333px]" data-name="Container">
...
function Container84() {
  return (
    <div className="bg-gray-50 h-[44px] relative rounded-[4px] shrink-0 w-full" data-name="Container">
      <div className="size-full">
        <div className="content-stretch flex items-start p-[12px] relative size-full">
          <p className="basis-0 font-['Arimo:Regular',sans-serif] font-normal grow leading-[20px] min-h-px min-w-px relative shrink-0 text-[#364153] text-[14px]">123 Main Street, Colombo 03</p>
        </div>
      </div>
    </div>
  );
...
function Container85() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[8px] h-[66px] items-start left-0 top-[272.64px] w-[445.333px]" data-name="Container">
      <PrimitiveLabelText text="Address" />
      <Container84 />
    </div>
  );
}
...
function Container86() {
  return (
    <div className="content-stretch flex h-[31.986px] items-start relative shrink-0 w-full" data-name="Container">
      <p className="basis-0 font-['Arimo:Regular',sans-serif] font-normal grow leading-[32px] min-h-px min-w-px relative shrink-0 text-[24px] text-center text-neutral-950">5</p>
    </div>
  );
}
...
function Container87() {
  return (
    <div className="absolute bg-gray-50 content-stretch flex flex-col gap-[4px] h-[107.958px] items-start left-0 pb-0 pt-[12px] px-[12px] rounded-[4px] top-0 w-[137.778px]" data-name="Container">
      <Container86 />
      <ContainerText6 text="Total Bookings" />
    </div>
  );
}
...
function Container88() {
  return (
    <div className="h-[63.972px] relative shrink-0 w-full" data-name="Container">
      <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[32px] left-[56.93px] text-[24px] text-center text-neutral-950 top-[-2px] translate-x-[-50%] w-[70px]">LKR 45,000</p>
    </div>
  );
}
...
function Container89() {
  return (
    <div className="absolute bg-gray-50 content-stretch flex flex-col gap-[4px] h-[107.958px] items-start left-[153.78px] pb-0 pt-[12px] px-[12px] rounded-[4px] top-0 w-[137.778px]" data-name="Container">
      <Container88 />
      <ContainerText6 text="Total Spent" />
    </div>
  );
}
...
function Container90() {
  return (
    <div className="content-stretch flex h-[20px] items-start relative shrink-0 w-full" data-name="Container">
      <p className="basis-0 font-['Arimo:Regular',sans-serif] font-normal grow leading-[20px] min-h-px min-w-px relative shrink-0 text-[14px] text-center text-neutral-950">3/15/2025</p>
    </div>
  );
}
...
function Container91() {
  return (
    <div className="absolute bg-gray-50 content-stretch flex flex-col gap-[4px] h-[107.958px] items-start left-[307.56px] pb-0 pt-[12px] px-[12px] rounded-[4px] top-0 w-[137.778px]" data-name="Container">
      <ContainerText6 text="Joined Date" />
      <Container90 />
    </div>
  );
}
...
function Container92() {
  return (
    <div className="h-[107.958px] relative shrink-0 w-full" data-name="Container">
      <Container87 />
      <Container89 />
      <Container91 />
    </div>
...
function Container93() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[8px] h-[129.958px] items-start left-0 top-[358.64px] w-[445.333px]" data-name="Container">
      <PrimitiveLabelText text="Booking Statistics" />
      <Container92 />
    </div>
  );
}
...
function Container94() {
  return (
    <div className="h-[35.986px] relative shrink-0 w-[187.069px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <Text10 text="Fashion Show - Sarah Johnson" />
        <ContainerText5 text="2025-11-15" />
      </div>
    </div>
  );
}
...
function Container95() {
  return (
    <div className="h-[20px] relative shrink-0 w-[67.694px]" data-name="Container">
      <Text9 text="LKR 15,000" />
    </div>
  );
}
...
function Container97() {
  return (
    <div className="absolute content-stretch flex h-[20px] items-start left-0 top-0 w-[178.861px]" data-name="Container">
      <p className="font-['Arimo:Regular',sans-serif] font-normal leading-[20px] relative shrink-0 text-[14px] text-neutral-950 text-nowrap whitespace-pre">Product Launch - Emily Davis</p>
    </div>
  );
}
...
function Container98() {
  return (
    <div className="absolute content-stretch flex h-[15.986px] items-start left-0 top-[20px] w-[178.861px]" data-name="Container">
      <p className="basis-0 font-['Arimo:Regular',sans-serif] font-normal grow leading-[16px] min-h-px min-w-px relative shrink-0 text-[#4a5565] text-[12px]">2025-10-22</p>
    </div>
  );
}
...
function Container99() {
  return (
    <Wrapper3 additionalClassNames="h-[35.986px] w-[178.861px]">
      <Container97 />
      <Container98 />
    </Wrapper3>
  );
...
function Container102() {
  return (
    <div className="h-[35.986px] relative shrink-0 w-[218.319px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <Text10 text="Commercial Shoot - Michael Brown" />
        <ContainerText5 text="2025-09-10" />
      </div>
    </div>
  );
}
...
function Container105() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] h-[195.958px] items-start relative shrink-0 w-full" data-name="Container">
      <Container96 />
      <Container101 />
      <Container104 />
    </div>
...
function Container106() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[8px] h-[217.958px] items-start left-0 top-[508.6px] w-[445.333px]" data-name="Container">
      <PrimitiveLabelText text="Recent Bookings" />
      <Container105 />
    </div>
  );
}
...
function Button13() {
  return (
    <div className="bg-white h-[36px] relative rounded-[8px] shrink-0 w-[67.972px]" data-name="Button">
      <div aria-hidden="true" className="absolute border-[0.889px] border-[rgba(0,0,0,0.1)] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <Text8 text="Close" additionalClassNames="px-[16.889px] py-[8.889px]" />
    </div>
  );
}
...
function Button14() {
  return (
    <div className="bg-white h-[36px] relative rounded-[8px] shrink-0 w-[131.5px]" data-name="Button">
      <div aria-hidden="true" className="absolute border-[0.889px] border-[rgba(0,0,0,0.1)] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <Text8 text="Reset Password" additionalClassNames="px-[16.889px] py-[8.889px]" />
    </div>
  );
}
...
function Button15() {
  return (
    <div className="bg-[#d4183d] h-[36px] relative rounded-[8px] shrink-0 w-[142.486px]" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center px-[16px] py-[8px] relative size-full">
        <p className="font-['Arimo:Regular',sans-serif] font-normal leading-[20px] relative shrink-0 text-[14px] text-center text-nowrap text-white whitespace-pre">Suspend Account</p>
      </div>
    </div>
  );
}
...
function Container107() {
  return (
    <div className="absolute content-stretch flex gap-[12px] h-[56.889px] items-start justify-end left-0 pb-0 pt-[20.889px] px-0 top-[746.56px] w-[445.333px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-[0.889px_0px_0px] border-[rgba(0,0,0,0.1)] border-solid inset-0 pointer-events-none" />
      <Button13 />
      <Button14 />
      <Button15 />
...
function CustomerManagement10() {
  return (
    <div className="absolute h-[803.444px] left-[24px] top-[-141.11px] w-[445.333px]" data-name="CustomerManagement">
      <Container79 />
      <Container83 />
      <Container85 />
      <Container93 />
...
function Icon19() {
  return (
    <Icon22 additionalClassNames="absolute left-[8.22px] top-[8.22px]">
...
function PrimitiveButton() {
  return (
    <div className="absolute bg-white border-[1.778px] border-gray-200 border-solid left-[437.33px] rounded-[2.98262e+07px] shadow-[0px_10px_15px_-3px_rgba(0,0,0,0.1),0px_4px_6px_-4px_rgba(0,0,0,0.1)] size-[40px] top-[-183.11px]" data-name="Primitive.button">
      <Icon19 />
      <DialogContent />
    </div>
  );
...
function Icon20() {
  return (
    <Icon21 additionalClassNames="absolute left-[16px] top-[16px]">
...
function App1() {
  return (
    <div className="absolute bg-black left-[1248.89px] opacity-[0.806] rounded-[2.98262e+07px] shadow-[0px_25px_50px_-12px_rgba(0,0,0,0.25)] size-[56px] top-[684.44px]" data-name="App">
      <Icon20 />
      <Text6 />
    </div>
  );
