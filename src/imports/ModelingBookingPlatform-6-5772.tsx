import svgPaths from "./svg-3pfdzlnmde";
import clsx from "clsx";

function BookingManagement11({ children }: React.PropsWithChildren<{}>) {
  return (
    <div className="bg-gray-50 h-[72px] relative rounded-[10px] shrink-0 w-[926.111px]">
...
type BookingManagement10Props = {
  additionalClassNames?: string;
};

function BookingManagement10({ children, additionalClassNames = "" }: React.PropsWithChildren<BookingManagement10Props>) {
  return (
...
function Icon20({ children, additionalClassNames = "" }: React.PropsWithChildren<Icon20Props>) {
  return (
...
function HeadingText1({ text }: HeadingText1Props) {
  return (
    <div className="h-[24px] relative shrink-0 w-full">
      <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[24px] left-0 text-[16px] text-neutral-950 text-nowrap top-[-2.11px] whitespace-pre">{text}</p>
    </div>
  );
}
type Icon13Props = {
...
function ContainerText6({ text }: ContainerText6Props) {
  return (
    <div className="absolute h-[20px] left-0 top-[20px] w-[287.361px]">
...
function Text9({ text }: Text9Props) {
  return (
    <div className="absolute content-stretch flex h-[20px] items-start left-0 top-[20px] w-[287.375px]">
...
function Icon() {
  return (
    <Icon20 additionalClassNames="relative shrink-0">
...
function Container9() {
  return (
    <Container91 additionalClassNames="w-[139.556px]">
      <Container7 />
      <Container8 />
    </Container91>
  );
...
function Container14() {
  return (
    <Container91 additionalClassNames="w-[159.153px]">
      <Container12 />
      <Container13 />
    </Container91>
  );
...
function Container18() {
  return (
    <Container91 additionalClassNames="w-[164px]">
      <Container16 />
      <Container17 />
    </Container91>
  );
...
function Container22() {
  return (
    <Container91 additionalClassNames="w-[146.278px]">
      <Container20 />
      <Container21 />
    </Container91>
  );
...
function Container26() {
  return (
    <Container91 additionalClassNames="w-[105.861px]">
      <Container24 />
      <Container25 />
    </Container91>
  );
...
function Container30() {
  return (
    <Container91 additionalClassNames="w-[128.625px]">
      <Container24 />
      <Container29 />
    </Container91>
  );
...
function Container37() {
  return (
    <Container91 additionalClassNames="w-[139.792px]">
      <Container33 />
      <Container36 />
    </Container91>
  );
...
function Container42() {
  return (
    <Container91 additionalClassNames="w-[155.194px]">
      <Container40 />
      <Container41 />
    </Container91>
  );
...
function Container47() {
  return (
    <Container91 additionalClassNames="w-[145.417px]">
      <Container44 />
      <Container46 />
    </Container91>
  );
...
function Dropdown() {
  return (
    <div className="absolute h-[40px] left-[268px] rounded-[8px] top-0 w-[120.889px]" data-name="Dropdown">
      ...
      <div className="size-full">
        <div className="content-stretch flex flex-col items-start pb-[0.889px] pl-[-1167px] pr-[1287.889px] pt-[-108.875px] relative size-full">
...
function BookingManagement() {
  return (
    <BookingManagement10 additionalClassNames="w-[236.417px]">
      <Container54 />
...
function Container57() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[8px] h-[120px] items-start left-0 top-0 w-[451.056px]" data-name="Container">
      <Text8 text="Model Details" />
      <Container56 />
    </div>
  );
}
...
function Container58() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] h-[92px] items-start relative shrink-0 w-full" data-name="Container">
      <Text8 text="John Smith" />
      <Text8 text="ABC Corporation" />
      <Text8 text="+94 77 123 4567" />
      <Text8 text="john@abc.com" />
    </div>
  );
}
...
function Container59() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[8px] h-[120px] items-start left-[475.06px] top-0 w-[451.056px]" data-name="Container">
      <Text8 text="Customer Details" />
      <Container58 />
    </div>
  );
}
...
function BookingManagement1() {
  return (
    <Wrapper8 additionalClassNames="h-[120px] w-[926.111px]">
      <Container57 />
      <Container59 />
    </Wrapper8>
  );
...
function Container60() {
  return (
    <div className="absolute h-[40px] left-0 top-0 w-[287.361px]" data-name="Container">
...
function Container61() {
  return (
    <div className="absolute h-[40px] left-[303.36px] top-0 w-[287.375px]" data-name="Container">
      <Text3 text="Location:" additionalClassNames="w-[55.681px]" />
      <Text9 text="Colombo Hilton" />
    </div>
  );
}
...
function BookingManagement3() {
  return (
    <div className="h-[48.889px] relative shrink-0 w-[926.111px]" data-name="BookingManagement">
...
function BookingManagement4() {
  return (
    <BookingManagement10 additionalClassNames="w-[328.014px]">
      <Container63 />
...
function Container67() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] h-[92px] items-start relative shrink-0 w-full" data-name="Container">
      <Text8 text="Jane Doe" />
      <Text8 text="XYZ Events" />
      <Text8 text="+94 71 234 5678" />
      <Text8 text="jane@xyz.com" />
    </div>
  );
}
...
function App() {
  return (
    <div className="absolute bg-gray-50 content-stretch flex flex-col h-[1194.208px] items-start left-0 top-0 w-[1311.889px]" data-name="App">
      <AdminApp />
    </div>
  );
}
...
function PrimitiveH() {
  return (
    <Wrapper8 additionalClassNames="h-[18px] w-[462.222px]">
      <p className="absolute font-['Arimo:Bold',sans-serif] font-bold leading-[18px] left-0 text-[18px] text-neutral-950 top-[-1.56px] w-[195px]">Booking Details - BR001</p>
    </Wrapper8>
  );
}
...
function PrimitiveP() {
  return (
    <div className="h-[20px] relative shrink-0 w-[462.222px]" data-name="Primitive.p">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="basis-0 font-['Arimo:Regular',sans-serif] font-normal grow leading-[20px] min-h-px min-w-px relative shrink-0 text-[#717182] text-[14px]">View detailed information about the booking.</p>
      </div>
    </div>
  );
}
...
function DialogHeader() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[8px] h-[46px] items-start left-[24px] top-[24px] w-[462.222px]" data-name="DialogHeader">
      <PrimitiveH />
      <PrimitiveP />
    </div>
  );
...
function Container77() {
  return (
    <div className="h-[20px] relative shrink-0 w-full" data-name="Container">
      <Text3 text="Event:" additionalClassNames="w-[36.819px]" />
      <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[20px] left-[36.82px] text-[14px] text-neutral-950 top-[-2px] w-[89px]">Fashion Show</p>
    </div>
  );
}
...
function Container78() {
  return (
    <div className="h-[20px] relative shrink-0 w-full" data-name="Container">
      <Text3 text="Date:" additionalClassNames="w-[32.042px]" />
      <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[20px] left-[32.04px] text-[14px] text-neutral-950 top-[-2px] w-[76px]">12/15/2025</p>
    </div>
  );
}
...
function Container79() {
  return (
    <div className="h-[20px] relative shrink-0 w-full" data-name="Container">
      <Text3 text="Time:" additionalClassNames="w-[33.153px]" />
      <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[20px] left-[33.15px] text-[14px] text-neutral-950 top-[-2px] w-[38px]">18:00</p>
    </div>
  );
}
...
function Container80() {
  return (
    <div className="h-[20px] relative shrink-0 w-full" data-name="Container">
      <Text3 text="Location:" additionalClassNames="w-[55.681px]" />
      <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[20px] left-[55.68px] text-[14px] text-neutral-950 top-[-2px] w-[103px]">Colombo Hilton</p>
    </div>
  );
}
...
function Container82() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[8px] h-[136px] items-start left-0 top-0 w-[223.111px]" data-name="Container">
      <HeadingText1 text="Event Information" />
      <Container81 />
    </div>
  );
}
...
function Container83() {
  return (
    <div className="h-[20px] relative shrink-0 w-full" data-name="Container">
      <Text3 text="Customer:" additionalClassNames="w-[62.764px]" />
      <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[20px] left-[62.76px] text-[14px] text-neutral-950 top-[-2px] w-[73px]">John Smith</p>
    </div>
  );
}
...
function Container84() {
  return (
    <div className="h-[20px] relative shrink-0 w-full" data-name="Container">
      <Text3 text="Company:" additionalClassNames="w-[62.028px]" />
      <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[20px] left-[62.03px] text-[14px] text-neutral-950 top-[-2px] w-[108px]">ABC Corporation</p>
    </div>
  );
}
...
function Container85() {
  return (
    <div className="h-[20px] relative shrink-0 w-full" data-name="Container">
      <Text3 text="Phone:" additionalClassNames="w-[42.25px]" />
      <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[20px] left-[42.25px] text-[14px] text-neutral-950 top-[-2px] w-[108px]">+94 77 123 4567</p>
    </div>
  );
}
...
function Container86() {
  return (
    <div className="h-[20px] relative shrink-0 w-full" data-name="Container">
      <Text3 text="Email:" additionalClassNames="w-[36.083px]" />
      <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[20px] left-[36.08px] text-[14px] text-neutral-950 top-[-2px] w-[97px]">john@abc.com</p>
    </div>
  );
}
...
function Container88() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[8px] h-[136px] items-start left-[239.11px] top-0 w-[223.111px]" data-name="Container">
      <HeadingText1 text="Contact Information" />
      <Container87 />
    </div>
  );
}
...
function Button15() {
  return (
    <div className="bg-[#030213] h-[36px] relative rounded-[8px] shrink-0 w-[66.194px]" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center px-[16px] py-[8px] relative size-full">
        <p className="font-['Arimo:Regular',sans-serif] font-normal leading-[20px] relative shrink-0 text-[14px] text-center text-nowrap text-white whitespace-pre">Close</p>
      </div>
    </div>
  );
}
...
function Container90() {
  return (
    <div className="content-stretch flex h-[52.889px] items-start pb-0 pt-[16.889px] px-0 relative shrink-0 w-full" data-name="Container">
      <div aria-hidden="true" className="absolute border-[0.889px_0px_0px] border-[rgba(0,0,0,0.1)] border-solid inset-0 pointer-events-none" />
      <Button15 />
    </div>
  );
...
function BookingManagement9() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[16px] h-[220.889px] items-start left-[24px] pb-0 pt-[16px] px-0 top-[86px] w-[462.222px]" data-name="BookingManagement">
      <Container89 />
      <Container90 />
    </div>
  );
...
function Icon18() {
  return (
    <Wrapper2 additionalClassNames="absolute left-[8.22px] top-[8.22px]">
...
function PrimitiveButton() {
  return (
    <div className="absolute bg-white border-[1.778px] border-gray-200 border-solid left-[454.22px] rounded-[2.98262e+07px] shadow-[0px_10px_15px_-3px_rgba(0,0,0,0.1),0px_4px_6px_-4px_rgba(0,0,0,0.1)] size-[40px] top-[16px]" data-name="Primitive.button">
      <Icon18 />
      <DialogContent />
    </div>
  );
...
function PrimitiveDiv1() {
  return (
    <div className="absolute bg-white border-[0.889px] border-[rgba(0,0,0,0.1)] border-solid h-[332.667px] left-[408.44px] rounded-[10px] shadow-[0px_10px_15px_-3px_rgba(0,0,0,0.1),0px_4px_6px_-4px_rgba(0,0,0,0.1)] top-[215.89px] w-[512px]" data-name="Primitive.div">
      <DialogHeader />
      <BookingManagement9 />
      <PrimitiveButton />
    </div>
...
function Icon19() {
  return (
    <Icon20 additionalClassNames="absolute left-[16px] top-[16px]">
...
function App1() {
  return (
    <div className="absolute bg-black left-[1248.89px] opacity-[0.927] rounded-[2.98262e+07px] shadow-[0px_25px_50px_-12px_rgba(0,0,0,0.25)] size-[56px] top-[684.44px]" data-name="App">
      <Icon19 />
      <Text7 />
    </div>
  );
